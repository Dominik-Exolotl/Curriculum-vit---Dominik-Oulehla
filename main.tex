...
\begin{minipage}[t]{\leftcolwidth}
    ...
    \small
    \begin{tabular}{r| p{0.6\textwidth} c}
        \cveventtinydescr{{2016--2020}}{Sborový zpěv}{Gymnázium Velké Meziříčí}{}{graphics/gvm-logo-RGB.jpg} \\
        ...
        \cveventtinydescr{\makecell[tr]{2022--\\Současnost}}{Schola VM}{Farnost Velké Meziříčí}{zvučení, stavba stage}{svg-inkscape/farnost_VM_svg-tex.pdf} \\
        \cveventtinydescr{\makecell[tr]{2022--\\Současnost}}{Chvály VM}{Farnost Velké Meziříčí}{zvučení, stavba stage}{svg-inkscape/farnost_VM_svg-tex.pdf}
    \end{tabular}  
\end{minipage}
}
%-----------------------------------------------------------
